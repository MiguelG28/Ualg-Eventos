...
![alt text](https://github.com/MiguelG28/Ualg-Eventos/tree/master/Examples/1-index.PNG "Home screen")

![alt text](https://github.com/MiguelG28/Ualg-Eventos/tree/master/Examples/9-edit_event.PNG "Main objective-An event is only edited by one person at a time")
